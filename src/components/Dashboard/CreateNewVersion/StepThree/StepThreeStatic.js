...
const StepThreeStatic = () => {
	return (
		<>
			<h3>Identify and eliminate non-productive coping methods.</h3>
			<p>
				The things that bother you can have a negative impact on your
...
export default StepThreeStatic;
